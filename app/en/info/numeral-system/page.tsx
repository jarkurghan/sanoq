        ...
        <div className="flex">
            <div className="flex-1 container py-4 px-4 sm:px-8 max-w-6xl ml-0 lg:ml-64 text-justify text-gray-700 dark:text-gray-300">
                ...
                <p className="mb-4">
                    ...
                    numbers; for example, Roman, Greek, and Egyptian numerals don't have a representation of the number zero.
                </p>
                ...
                <p>
                    Numeral systems are sometimes called <em>number systems</em>, but that name is ambiguous, as it could refer to different systems of numbers,
                    such as the system of real numbers, the system of complex numbers, various hypercomplex number systems, the system of p-adic numbers, etc.
                    Such systems are, however, not the topic of this article.
                </p>
                <h2 className="text-xl font-bold my-4">History</h2>
                <p className="mb-4">
                    According to scholars, early numeral systems are believed to have varied across civilizations, with the Babylonians using a base-60 system,
                    the Egyptians developing hieroglyphic numerals, and the Chinese employing rod numerals. The Mayans independently created a vigesimal
                    (base-20) system that included a symbol for zero.
                </p>
                <Image
                ...
                />
                <p className="mb-4">
                    Indian mathematicians, such as <strong>Brahmagupta</strong> in the 7th century, played a crucial role in formalizing arithmetic rules and
                    the concept of zero, which was later refined by scholars like <strong>Al-Khwarizmi</strong> in the Islamic world. As these numeral systems
                    evolved, the efficiency of positional notation and the inclusion of zero helped shape modern numerical representation, influencing global
                ...
                <p className="mb-4">
                    ...
                    accepted. Instead of a zero sometimes the digits were marked with dots to indicate their significance, or a space was used as a placeholder.
                    The first widely acknowledged use of zero was in <strong>876</strong>
                ...
                <p className="mb-4">
                    ...
                    used them in his <em>Liber Abaci</em>). Initially met with resistance, Hindu–Arabic numerals gained wider acceptance in Europe due to their
                    efficiency in arithmetic operations, particularly in banking and trade.
                </p>
                <p className="mb-4">
                    The invention of the printing press in the 15th century helped standardize their use, as printed mathematical texts favored this system over
                    Roman numerals. They began to enter common use in the 15th century<sup className="text-gray-400">[3]</sup>. By the end of the 20th century
                    virtually all non-computerized calculations in the world were done with Arabic numerals, which have replaced native numeral systems in most
                    cultures.
                </p>
                <p>
                    ...
                    numerals facilitated global finance, engineering, and technological developments, forming the foundation for modern computing and digital
                    data representation.
                </p>
                ...
                <p className="mb-4">
                    The <strong>Thai numeral system</strong> is identical to the Hindu–Arabic numeral system except for the symbols used to represent digits.
                ...
                <p className="mb-4">
                    The <em>Sūnzĭ Suànjīng</em>, a mathematical treatise dated to between the 3rd and 5th centuries AD, provides detailed instructions for the
                    system, which is thought to have been in use since at least the 4th century BC.
                ...
                <p className="mb-4">
                    ...
                    If the symbol / is chosen, for example, then the number seven would be represented by ///////. Tally marks represent one such system still
                    in common use. The unary system is only useful for small numbers, although it plays an important role in theoretical computer science. Elias
                    gamma coding, which is commonly used in data compression, expresses arbitrary-sized numbers by using unary to indicate the length of a
                    binary numeral.
                </p>
                <p className="mb-4">
                    The unary notation can be abbreviated by introducing different symbols for certain new values. Very commonly, these values are powers of 10;
                    so for instance, if / stands for one, − for ten and + for 100, then the number 304 can be compactly represented as +++ //// and the number
                    123 as + − − /// without any need for zero. This is called sign-value notation. The ancient Egyptian numeral system was of this type, and
                    the Roman numeral system was a modification of this idea.
                </p>
                <p className="mb-4">
                    More useful still are systems which employ special abbreviations for repetitions of symbols; for example, using the first nine letters of
                    the alphabet for these abbreviations, with A standing for "one occurrence", B "two occurrences", and so on, one could then write C+ D/ for
                ...
                <p className="mb-4">
                    ...
                    is used to signify the power of ten that the digit is to be multiplied with, as in 304 = 3×100 + 0×10 + 4×1 or more precisely 3×10² + 0×10¹
                    + 4×10⁰. Zero, which is not needed in the other systems, is of crucial importance here, in order to be able to "skip" a power. The
                    Hindu–Arabic numeral system, which originated in India and is now used throughout the world, is a positional base 10 system.
                </p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    In computers, the main numeral systems are based on the positional system in base 2 (binary numeral system), with two binary digits, 0 and
                    1. Positional systems obtained by grouping binary digits by three (octal numeral system) or four (hexadecimal numeral system) are commonly
                    used. For very large integers, bases 2³² or 2⁶⁴ (grouping binary digits by 32 or 64, the length of the machine word) are used, as, for
                    example, in GMP.
                </p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    ...
                    1, 2, 3, 4, 5, 6, 7, 8, 9) and the geometric numerals (1, 10, 100, 1000, 10000 ...), respectively. The sign-value systems use only the
                    geometric numerals and the positional systems use only the arithmetic numerals. A sign-value system does not need arithmetic numerals
                    because they are made by repetition (except for the Ionic system), and a positional system does not need geometric numerals because they are
                    made by position. However, the spoken language uses both arithmetic and geometric numerals.
                </p>
                <p>
                    ...
                    <em>k</em> (<em>k</em> ≥ 1), and zero being represented by an empty string. This establishes a bijection between the set of all such
                    digit-strings and the set of non-negative integers, avoiding the non-uniqueness caused by leading zeros. Bijective base-<em>k</em>{" "}
                    numeration is also called <em>k</em>-adic notation, not to be confused with p-adic numbers. Bijective base 1 is the same as unary.
                </p>
                <h2 className="text-xl font-bold my-4">Positional systems in detail</h2>
                <p className="mb-4">
                    In a positional base <em>b</em> numeral system (with <em>b</em> a natural number greater than 1 known as the radix or base of the system),{" "}
                    <em>b</em> basic symbols (or digits) corresponding to the first <em>b</em> natural numbers including zero are used. To generate the rest of
                    the numerals, the position of the symbol in the figure is used. The symbol in the last position has its own value, and as it moves to the
                    left its value is multiplied by <em>b</em>.
                </p>
                <p className="mb-4">
                    For example, in the <strong>decimal</strong> system (base 10), the numeral 4327 means (4×10³) + (3×10²) + (2×10¹) + (7×10⁰), noting that 10⁰
                    = 1.
                </p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    ...
                    non-repeating digits) in all integral bases. Thus, for example in base 2, π = 3.1415926...₁₀ can be written as the aperiodic
                    11.001001000011111...₂.
                </p>
                <p className="mb-4">
                    Putting overscores,{" "}
                ...
                <p className="mb-4">
                    There are also so-called threshold values <code>t₀, t₁, ...</code> which are fixed for every position in the number. A digit <code>aᵢ</code>{" "}
                    (in a given position in the number) that is lower than its corresponding threshold value <code>tᵢ</code> means that it is the
                    most-significant digit. Hence, in the string, this marks the end of the number, and the next symbol (if present) is the least-significant
                    digit of the next number.
                </p>

                <p className="mb-4">
                    For example, if the threshold value for the first digit is <code>b = 1</code>, then <code>a = 0</code> marks the end of the number (it has
                ...
                <p className="mb-4">
                    Suppose the threshold values for the second and third digits are <code>c = 2</code>. Then the second-digit range is <code>a–b</code> (i.e.,
                    0–1) if it is the most significant digit, and <code>c–9</code> (i.e., 2–35) if there is a third digit. Generally, for any <em>n</em>, the
                    weight of the (n + 1)-th digit is the weight of the previous one multiplied by <code>36 − tₙ</code>.
                </p>
                ...
                <p className="mb-4">
                    Unlike a regular n-based numeral system, there are numbers like <code>9b</code> where both <code>9</code> and <code>b</code> each represent
                    35. Yet the representation is unique because <code>ac</code> and <code>aca</code> are not allowed — the first <code>a</code> would terminate
                    each of these numbers.
                </p>

                <p className="mb-4">
                    The flexibility in choosing threshold values allows optimization for number of digits depending on the frequency of occurrence of numbers of
                    various sizes.
                </p>
