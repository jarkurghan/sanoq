        ...
        <div className="flex">
            <div className="flex-1 container py-4 px-4 sm:px-8 max-w-6xl ml-0 lg:ml-64">
                <article className="prose max-w-none text-justify">
                    <h1 className="text-2xl font-bold mb-6">O‘nlik sanoq sistemasi tarixi</h1>

                    <h2 className="text-xl">O‘nlik sanoq sistemasi nima?</h2>
                    <p>
                    ...
                    <p>
                        ...
                        <b>kundalik hayotimizda foydalanadigan matematika va sonlar</b>. Ya’ni, biz yozadigan har bir son, nafaqat hisob-kitoblar, balki
                        tug‘ilgan sanadan tortib, telefondagi kontakt raqamigacha — aslida 0 dan 9 gacha bo‘lgan raqamlar yordamida tuziladi.
                    </p>
                    ...
                    <h2 className="text-xl">Nega aynan 10 asosli?</h2>
                    ...
                    <h2 className="text-xl">Tarixiy ildizlari</h2>
                    <ul>
                        <li>
                    ...
                    <h2 className="text-xl">0 raqami – inqilobiy kashfiyot</h2>
