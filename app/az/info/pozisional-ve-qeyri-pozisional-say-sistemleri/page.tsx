...
export function generateMetadata(): Metadata {
    return {
        ...
        keywords: ["say sistemi", "pozisional say sistemi", "qeyri-pozisional say sistemi", "Rim rəqəmləri", "say sistemlərinin fərqi"],
        ...
        openGraph: {
            title: "Pozisional və qeyri-pozisional say sistemləri",
            description: "Bu məqalə say sistemləri anlayışını sadə və praktik nümunələrlə izah edir.",
            url: "https://sanoq.uz/az/info/pozisional-ve-qeyri-pozisional-say-sistemleri",
            siteName: "sanoq.uz",
            images: [
                {
        ...
        alternates: {
            canonical: "https://sanoq.uz/az/info/pozisional-ve-qeyri-pozisional-say-sistemleri",
            languages: {
