    ...
    <div className="flex">
      <div className="flex-1 container py-4 max-w-6xl ml-0 lg:ml-64">
        <article className="prose max-w-none">
          ...
          <p className="text-sm">
            The binary number system is a base-2 number system that uses only two digits: 0 and 1. It is the foundation
            of all digital computing and electronic systems.
          </p>

          <h2>Why is Binary Important?</h2>
          <p className="text-sm">
            Binary is fundamental to computing because electronic components can easily represent two states: on (1) and
            off (0). This makes binary the natural language of computers.
          </p>
