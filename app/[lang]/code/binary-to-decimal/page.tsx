        ...
        <div className="flex">
            <div className="flex-1 container py-4 max-w-6xl ml-0 lg:ml-64">
                <article className="prose max-w-none">
                    ...
                    <p className="text-sm">
                        Converting binary numbers to decimal is a fundamental operation in computer science. Here are several ways to implement this conversion
...
int main() {
    ...
    return 0;
                    ...
                    <p className="text-sm">This algorithm has a time complexity of O(n), where n is the number of digits in the binary number.</p>
                </article>
            </div>
